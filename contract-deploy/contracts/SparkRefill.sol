...
/**
 * @title SparkRefill
 * @notice Pay a configurable fee in USDT or USDC to refill sparks on Celo Mainnet.
 * @dev Supports two ERC-20 tokens with separate accounting and shared access control.
 *      The refill fee is owner-adjustable post-deployment (e.g. for promotional discounts)
...
contract SparkRefill {
    ...
    /// @notice Current refill fee, in the token's smallest unit (USDT/USDC use 6 decimals).
